...
<div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="jumbotron cert-jumb">
                     <strong><?php echo $firstname;?></strong>  
                      <?php 
                      if (!empty($certname) ) {
                        echo "is currently a/an <strong>";
                        echo $certname;
                        echo "</strong> Holder";
                      }else {
                        
                        echo "currently does not have a certificate";
                      }
                      ?>
    ...
    <div class="footer">
             ...
             <div class="row">
                       <div class="col-lg-12" >
  <p> &copy E-Appraisal System IMT <script> document.write( new Date().getFullYear());</script></p> 
                </div>
        </div>
        </div>
